param(
    [switch]$Pull,
    [switch]$Rebuild,
    [string]$ShmName = "lab3_counter",
    [string]$LogFile = "./logs/log.log",
    [string]$IncrementExe = "increment_counter.exe",
    [string]$MultiplyExe = "multiply_counter.exe"
)
...
$Args = @($ShmName, $LogFile, $IncrementExe, $MultiplyExe)
