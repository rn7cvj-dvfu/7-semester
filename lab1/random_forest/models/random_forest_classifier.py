...
class RandomForestClassifier:
    ...
    def __init__(
        ...
        bootstrap: bool = True,
        split_metric: ClassificationMetric = None,
    ...
    def _bootstrap_sample(self, X: np.ndarray, y: np.ndarray) -> tuple:
        ...
        Returns:
            (X_sample, y_sample): Бутстрэп-выборка признаков и меток классов.
        """
        n_samples = X.shape[0]
    ...
    def fit(self, X: np.ndarray, y: np.ndarray) -> None:
        """
        Обучает случайный лес для классификации.
    ...
    def predict(self, X: np.ndarray) -> np.ndarray:
        ...
        Returns:
            predictions (np.ndarray): Предсказанные классы (голосование большинством).
